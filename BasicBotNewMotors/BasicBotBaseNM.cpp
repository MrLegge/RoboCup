...
#include "BasicBotBaseNM.h"

  BasicBotBaseNM::BasicBotBaseNM(){
  ...
  void BasicBotBaseNM::driveForward(unsigned short rightWheel, unsigned short leftWheel){
      _motorRight->setSpeed(rightWheel);
      _motorLeft->setSpeed(leftWheel);
      _motorRight->backward();
      _motorLeft->forward();
    }
  void BasicBotBaseNM::driveBackward(unsigned short rightWheel, unsigned short leftWheel){
      _motorRight->setSpeed(rightWheel);
      _motorLeft->setSpeed(leftWheel);
      _motorRight->forward();
      _motorLeft->backward();
  ...
  void BasicBotBaseNM::rotateRight(unsigned short turnSpeed){
